...
{
    [TestClass()]
    public class SaveCharakterXMLTests01 : Abstract_SaveCharakterXMLTests
    {
        ...
        [TestInitialize]
        public void setUP_SaveCharakterXMLTests01()
        {
            Console.WriteLine("Aufrufer: setUP_SaveCharakterXMLTests01");
        }
    }
}