...
{
    [TestClass()]
    public class TalentKnwoldageTests : TalentGeneralTests
    {
        public override TalentGeneral getTalentGeneralWithoutDeviateRequirement()
        {
            return new TalentKnwoldage(TalentName, attributeList, BE, new List<TalentDeviate>(0), new List<TalentRequirement>(0));
        }
        public override TalentGeneral getTalentGeneralWithDeviate()
        {
            return new TalentKnwoldage(TalentName, attributeList, BE, deviateList, new List<TalentRequirement>(0));
        }
        public override TalentGeneral getTalentGeneralWithRequirement()
        {
            return new TalentKnwoldage(TalentName, attributeList, BE, new List<TalentDeviate>(0), requirementList);
        }
        public override TalentGeneral getTalentGeneralWithDeviateRequirement()
        {
            return new TalentKnwoldage(TalentName, attributeList, BE, deviateList, requirementList);
        }
