...
{
    [TestClass()]
    public class TalentNatureTests : TalentGeneralTests
    {
        public override TalentGeneral getTalentGeneralWithoutDeviateRequirement()
        {
            return new TalentNature(TalentName, attributeList, BE, new List<TalentDeviate>(0), new List<TalentRequirement>(0));
        }
        public override TalentGeneral getTalentGeneralWithDeviate()
        {
            return new TalentNature(TalentName, attributeList, BE, deviateList, new List<TalentRequirement>(0));
        }
        public override TalentGeneral getTalentGeneralWithRequirement()
        {
            return new TalentNature(TalentName, attributeList, BE, new List<TalentDeviate>(0), requirementList);
        }
        public override TalentGeneral getTalentGeneralWithDeviateRequirement()
        {
            return new TalentNature(TalentName, attributeList, BE, deviateList, requirementList);
        }
