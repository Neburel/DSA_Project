...
namespace DSA_Project
{
    public partial class DSA : Form
    {
        ...
        int HeroPageSupportedAdvantagesDisadvantagesBoxes = 15;
        int SUpportedTalentCOunt = 30;
        int supportedRewardBoxes = 25;

        List<Label> HeroPageAttributLabels;
        List<TextBox> HeroPageBasicValueBoxes;
        List<TextBox> HeroPageAttributAKTBoxes;
        List<TextBox> HeroPageAttributMODBoxes;
        List<TextBox> HeroPageAttributMAXBoxes;
        List<TextBox> HeroPageAdvancedAKTBoxes;
        List<TextBox> HeroPageAdvancedMODBoxes;
        List<TextBox> HeroPageAdvancedMAXBoxes;
        List<TextBox> HeroPageEnergienAKTBoxes;
        List<TextBox> HeroPageEnergienPERBoxes;
        List<TextBox> HeroPageEnergienMALBoxes;
        List<TextBox> HeroPageEnergienERGBoxes;
        List<TextBox> HeroPageMoneyBoxes;
        ...
        List<RadioButton> TalentPageRadioButtonsGeneralTalents;
        List<RadioButton> TalentPageRadioButtonsFightingTalents;
        ...
        private void setUPHeroPageAttribute()
        {
            ...
            HeroPageAttributAKTBoxes = new List<TextBox> { txtMutAKT, txtKlugheitAKT, txtIntuitionAKT, txtCharismaAKT, txtFingerfertigkeitAKT, textGewandheitAKT, txtKonstitutionAKT, txtKörperkraftAKT, txtSozialstatusAKT };
            HeroPageAttributMODBoxes = new List<TextBox> { txtMutMOD, txtKlugheitMOD, txtIntuitionMOD, txtCharismaMOD, txtFingerfertigkeitMOD, textGewandheitMOD, txtKonstitutionMOD, txtKörperkraftMOD, txtSozialstatusMOD };
            HeroPageAttributMAXBoxes = new List<TextBox> { txtMutMAX, txtKlugheitMAX, txtIntuitionMAX, txtCharismaMAX, txtFingerfertigkeitMAX, textGewandheitMAX, txtKonstitutionMAX, txtKörperkraftMAX, txtSozialstatusMAX };
            ...
            lblGewandheit.Tag       = textGewandheitAKT.Tag = textGewandheitMOD.Tag = textGewandheitMAX.Tag = DSA_ATTRIBUTE.GE;
            ...
            {
                HeroPageAttributAKTBoxes[i].TextChanged += new EventHandler(txtAttributAKT_TextChanged);
                HeroPageAttributMODBoxes[i].TextChanged += new EventHandler(txtAttributMOD_TextChanged);
                HeroPageAttributMAXBoxes[i].TextChanged += new EventHandler(txtAttributMAX_TextChanged);
                HeroPageAttributLabels[i].Click         += new EventHandler(markElement);
            }
        ...
        public void loadHeroPageAttributValues()
        {
            ...
            txtMutAKT.Text = controll.AttributeAKT(DSA_ATTRIBUTE.MU).ToString();
            txtKlugheitAKT.Text = controll.AttributeAKT(DSA_ATTRIBUTE.KL).ToString();
            txtIntuitionAKT.Text = controll.AttributeAKT(DSA_ATTRIBUTE.IN).ToString();
            txtCharismaAKT.Text = controll.AttributeAKT(DSA_ATTRIBUTE.CH).ToString();
            txtFingerfertigkeitAKT.Text = controll.AttributeAKT(DSA_ATTRIBUTE.FF).ToString();
            textGewandheitAKT.Text = controll.AttributeAKT(DSA_ATTRIBUTE.GE).ToString();
            txtKonstitutionAKT.Text = controll.AttributeAKT(DSA_ATTRIBUTE.KO).ToString();
            txtKörperkraftAKT.Text = controll.AttributeAKT(DSA_ATTRIBUTE.KK).ToString();
            txtSozialstatusAKT.Text = controll.AttributeAKT(DSA_ATTRIBUTE.SO).ToString();
        ...
        public void refreshHeroPageAttributValues()
        {
            txtMutMAX.Text = controll.AttributeMAX(DSA_ATTRIBUTE.MU).ToString();
            txtKlugheitMAX.Text = controll.AttributeMAX(DSA_ATTRIBUTE.KL).ToString();
            txtIntuitionMAX.Text = controll.AttributeMAX(DSA_ATTRIBUTE.IN).ToString();
        ...
        private void txtAttributAKT_TextChanged(object sender, EventArgs e)
        {
            TextBox box = (TextBox)sender;
            box.Text = controll.AttributeAKT((DSA_ATTRIBUTE)box.Tag, box.Text).ToString();
        }
        private void txtAttributMOD_TextChanged(object sender, EventArgs e)
        {
            TextBox box = (TextBox)sender;
            box.Text = controll.AttributeMOD((DSA_ATTRIBUTE)box.Tag, box.Text).ToString();
        }
        private void txtAttributMAX_TextChanged(object sender, EventArgs e)
        {
            TextBox box = (TextBox)sender;
        ...
        private void markElement(object sender, EventArgs e)
        {
            Label lbl = (Label)sender;
            DSA_ATTRIBUTE atr = (DSA_ATTRIBUTE)lbl.Tag;
            int x = (int)atr;

            changeAttributMark(atr, HeroPageAttributLabels[x], HeroPageAttributAKTBoxes[x], HeroPageAttributMODBoxes[x], HeroPageAttributMAXBoxes[x]);
        }
